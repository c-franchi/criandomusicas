...
const PricingPlans = () => {
  ...
  return <div className="py-16 bg-gradient-to-br from-gray-50 to-white">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          {plans.map(plan => <Card key={plan.id} className={`relative transition-all duration-300 hover:shadow-xl h-full flex flex-col ${plan.popular ? "ring-2 ring-purple-500 shadow-lg scale-105" : "hover:shadow-lg"}`}>
              ...
              <CardHeader className="text-center pb-4">
                ...
                <div className="text-3xl font-bold text-purple-600 mt-2">
                  {plan.price}
                  {plan.id === "subscription" && <span className="text-sm font-normal text-gray-500">/mês</span>}
                </div>
              ...
              <CardContent className="space-y-4 mt-auto">
                ...
                <div className="mt-6">
                  <Button onClick={() => handlePlanSelect(plan.id)} variant={plan.buttonVariant} className={`w-full ${plan.popular ? "bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white" : ""}`}>
                    {plan.buttonText}
                  </Button>
                </div>
              </CardContent>
