...
const SEO = ({
  title,
  description = 'Crie músicas personalizadas com inteligência artificial. Transforme sua história em uma canção única e emocionante. Entrega em até 24h diretamente na plataforma.',
