        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li><button onClick={() => scrollToSection('processo')} className="hover:text-primary transition-colors text-left">{t('footer.howItWorks')}</button></li>
              <li><button onClick={() => scrollToSection('exemplos')} className="hover:text-primary transition-colors text-left">{t('footer.examples')}</button></li>
              <li><Link to="/planos" className="hover:text-primary transition-colors">{t('footer.pricing')}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><Link to="/regras" className="hover:text-primary transition-colors">{t('footer.rules')}</Link></li>
              <li>
